...
export const benefits = [
  ...
  {
    id: "1",
    title: "Project expo  (Project presentation)",
...

  {
    id: "4",
    title: " Code arena  ",
    text: "Technical codeing cover a wide range of technical concepts and ideas: From how a technology or process works, to how to perform a specific task, to lessons learned in a Subjects and Project.",
  ...
  {
    id: "5",
    title: " Knock of the bug (circuit debugging )",
  ...
  {
    id: "6",
    title: "Spell Tech  (Tech Talk )  ",
    text: "The Tech Talk  are designed to educate, inspire, and connect people within the tech community. They often feature experts or enthusiasts sharing their knowledge and experiences.",
    backgroundUrl: "./src/assets/benefits/card-3.svg",
    iconUrl: benefitIcon3,
    imageUrl: benefitImage2,
  },
